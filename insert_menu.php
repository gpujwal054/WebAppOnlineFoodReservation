	    ...
	    <div class="content" style="width:70%;float:right;height:515px;background-color: #BFF908">
	      	<form class="col-12 offset-0 mt-5">
			  	<div class="form-group row">
				    <label for="enterFoodName" class="col-3">Menu Item Name</label>
				    <div class="col-8" style="padding-left: 0px">
				    	<input type="text" class="form-control form-control-sm" id="food_name" placeholder="Enter menu item name">
					</div>
			  	</div>
			  	<div class="form-group row">
