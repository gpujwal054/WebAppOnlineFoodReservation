...
<body>
	<div class="sidebar" style="width: 30%;background-color: #6B2B23;float: left;height: 515px">
		<ul style="padding: 0;margin-top: 5px">
			...
			<div class="col-10">
				<li style="display: block;"><a href="insert_subCat.php" style="font-family: times new roman;font-size: 24px;color: white">Insert Sub-Category</a></li>
			</div>
			<div class="col-10">
			...
			<div class="col-10">
				<li style="display: block;"><a href="terms_conditions.php" style="font-family: times new roman;font-size: 24px;color: white">Terms and conditions</a></li>
			</div>
			<div class="col-10">
				<li style="display: block;"><a href="privacy.php" style="font-family: times new roman;font-size: 24px;color: white">Privacy</a></li>
			</div>
		</ul>
	</div>
</body>
